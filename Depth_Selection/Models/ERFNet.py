...
class Decoder (nn.Module):
    def __init__(self, num_classes, multi):
        super().__init__()
...
class Net(nn.Module):
    def __init__(self, args, out_channels=1, drop=0.3, multi=True):  #use encoder to pass pretrained encoder
        super().__init__()

        self.encoder = Encoder(args.channels_in, out_channels, drop=drop)
        self.decoder = Decoder(out_channels, multi)
