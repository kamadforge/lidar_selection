...
class Encoder(nn.Module):
    def __init__(self, in_channels, num_classes, drop):
        ...
        self.conv1 = nn.Conv2d(32, chans, (3, 3), stride=1, padding=1, bias=True)
        self.bn1 = nn.BatchNorm2d(chans, eps=1e-3)
...
class Net(nn.Module):
    def __init__(self, args):  #use encoder to pass pretrained encoder
        super().__init__()
        out_channels = 1
        self.encoder = Encoder(args.channels_in, out_channels, drop=args.drop)
