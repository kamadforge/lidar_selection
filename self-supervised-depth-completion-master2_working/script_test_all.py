...
def test_switch(checkpoint_path, rank_file, input_form):
    ...
    if socket.gethostname()=='kamilblade':
        subprocess.run(["python", "main_orig_jul26.py", "--data-folder",  "/home/kamil/Dropbox/Current_research/data/kitti", "--i", input_form, "--epochs", "20", "-e", checkpoint_path,  "--seed", "121", "--type_feature", "sq", "--test_mode", "switch", "--feature_mode", "global",  "--feature_num", "10", "--rank_file_global_sq", rank_file])
    else:
