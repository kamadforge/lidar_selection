...
from features.depth_manipulation_jul26 import depth_adjustment, depth_adjustment_lines
...
parser.add_argument('--rank_file_global_sq', default=f"ranks/sq/global/checkpoint_qnet-9_i_0_typefeature_None.pth.tar/mode=dense.input=gd.resnet34.criterion=l2.lr=0.01.bs=1.wd=0.0.pretrained=False.jitter=0.1.time=2021-07-23@17-46/Ss_val_ep_11_it_1560.npy")
    ...
    for i, batch_data in enumerate(loader):
        ...
        if depth_adjust and args.use_d:
            if args.type_feature == "sq":
                if args.use_rgb:
                    depth_new, alg_mode, feat_mode, features, shape = depth_adjustment(batch_data['d'], args.test_mode, args.feature_mode, args.feature_num, args.rank_file_global_sq, adjust_features, i, model_orig, args.seed,  batch_data['rgb'])
                else:
